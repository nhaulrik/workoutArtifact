...
--changeset nch:1606942228031-5
CREATE TABLE workout_exercise (id VARCHAR(255) NOT NULL, exercise_number INT NULL, exercise_id VARCHAR(255) NULL, session_id VARCHAR(255) NULL, CONSTRAINT workout_exercisePK PRIMARY KEY (id));

--changeset nch:1606942228031-6
CREATE TABLE workoutset (id VARCHAR(255) NOT NULL, repetition_maximum INT NULL, repetitions INT NULL, set_number INT NULL, single BIT NULL, weight DOUBLE NULL, workout_exercise_id VARCHAR(255) NULL, CONSTRAINT workoutsetPK PRIMARY KEY (id));

--changeset nch:1606942228031-7
ALTER TABLE session ADD CONSTRAINT FK_session_user_id FOREIGN KEY (user_id) REFERENCES user (id);

--changeset nch:1606942228031-8
ALTER TABLE workout_exercise ADD CONSTRAINT FK_workout_exercise_exercise_id FOREIGN KEY (exercise_id) REFERENCES exercise (id);

--changeset nch:1606942228031-9
ALTER TABLE workout_exercise ADD CONSTRAINT FK_workout_exercise_session_id FOREIGN KEY (session_id) REFERENCES session (id);

--changeset nch:1606942228031-10
