...
CREATE TABLE workoutset (id VARCHAR(255) NOT NULL, repetition_maximum INT NULL, repetitions INT NULL, set_number INT NULL, single BIT NULL, weight DOUBLE NULL, exercise_id VARCHAR(255) NULL, session_id VARCHAR(255) NULL, CONSTRAINT workoutsetPK PRIMARY KEY (id));
