...
import com.workout.workoutArtifact.application.WorkoutSetApplicationService;
...
public class WorkoutSetFacade {
  ...
  private final WorkoutSetApplicationService workoutSetApplicationService;
  ...
  public PostWorkoutSetResponse postWorkoutSet(List<PostWorkoutSetRequest> postWorkoutSetRequests) {
    ...
    postWorkoutSetRequests.forEach(postWorkoutSetRequest -> {
      workoutSetIds.add(workoutSetApplicationService.handleWorkoutSet(
