...
public class AbstractSpecificationTest {
    ...
    public void and() {
        ...
        assertThat(((AndSpecification<Object>)abstractSpecification).getSet(), Matchers.hasItems(specification, specification2));
    }
    ...
    public void or() {
        ...
        assertThat(((OrSpecification<Object>)abstractSpecification).getSet(), Matchers.hasItems(specification, specification2));
    }
    ...
    public void not() {
        ...
        assertThat(((NotSpecification<Object>)notSpecification).getSpecification(), CoreMatchers.is(specification));
    }
}
