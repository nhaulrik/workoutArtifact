...
public class NotSpecificationTest {
    ...
    public void negatePositiveResult() {
        ...
        assertThat(notSpecification.getSpecification(), CoreMatchers.is(trueSpecification));
    ...
    public void negateNegativeResult() {
        ...
        assertThat(notSpecification.getSpecification(), CoreMatchers.is(falseSpecification));
