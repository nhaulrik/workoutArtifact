...
public class AndSpecificationTest {
    ...
    public void twoTrueSpecifications() {
        ...
        assertThat(andSpecification.getSet(), hasItems(trueSpecification, trueSpecification2));
    ...
    public void oneTrueOneFalseSpecification() {
        ...
        assertThat(andSpecification.getSet(), hasItems(trueSpecification, falseSpecification));
    ...
    public void twoFalseSpecifications() {
        ...
        assertThat(andSpecification.getSet(), hasItems(falseSpecification, falseSpecification2));
        assertThat(andSpecification.isSatisfiedBy(null), is(false));
    }
    ...
    public void chainingAndSpecification() {
        ...
        assertThat(andSpecification.getSet(), hasItems(trueSpecification, trueSpecification2, trueSpecification3));
    }
}
